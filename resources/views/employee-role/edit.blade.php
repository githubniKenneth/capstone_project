        ...
        <div class="w-100 p-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="{{ route('employee-role.index') }}" class="text-decoration-none">Employee Role</a></li>
                    <li class="breadcrumb-item" aria-current="page">Add Branch</li>
                </ol>
            </nav>
            <div class="p-3 d-flex justify-content-center">
                <form action="/personnel/employee-role/{{$employee_role->id}}" method="POST" class="d-flex flex-column w-100">
                    @method('PUT')
                    @csrf
                                ...
                                <div class="row d-flex p-3">
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="empr_role" value="{{ $employee_role->empr_role }}">
                                            @error('empr_role')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="empr_desc" value="{{ $employee_role->empr_desc }}">
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-2">
                        ...
                        <div>
                            <a href="{{ route('employee-role.index') }}" class="btn btn-secondary rounded">Cancel</a>
