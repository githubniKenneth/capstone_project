    ...
    @section('content')
        <div class="w-100 p-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="{{ route('employee-role.index') }}" class="text-decoration-none">Employee Roles</a></li>
                    <li class="breadcrumb-item" aria-current="page">Add Employee Role</li>
                </ol>
            </nav>
            <div class="p-3 d-flex justify-content-center">
                <form action="/personnel/employee-role/add" method="POST" class="d-flex flex-column w-100">
                    @csrf
        ...
        <script>
            swal({
                ...
                window.location.href =  "{{ route('employee-role.index') }}";
            })
        </script>
        @endif
    @endsection