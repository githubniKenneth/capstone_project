                            ...
                            <div class="row d-flex box-row">
                                    ...
                                    <div class="form-group d-flex flex-column">
                                        ...
                                        <select name="quotation_id" id="selectQuotation" class="form-control">
                                            ...
                                            @foreach ($quotation_numbers as $quote)
                                                <option value="{{$quote->id}}">{{$quote->quote_control_number}}</option>
                                            @endforeach
                                        </select>
                                        @error('rec_code')
                                            <p class="text-danger">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group d-flex flex-column">
                                        ...
                                        <input class="form-control d-none" type="text" name="order_number" value="{{$newOrderNumber}}" readonly>
                                        <input class="form-control" type="text" name="order_control_no" value="{{$newControlNo}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row d-flex box-row">
                            ...
                            <div class="row d-flex box-row">
                                <div class="col-md-6">
                                    <div class="form-group d-flex flex-column">
                                        ...
                                        <textarea class="form-control" type="text" id="client_address" name="order_address" cols="30" rows="2" readonly></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group d-flex flex-column">
                                        ...
                                        <textarea class="form-control" name="order_remarks" id="remarks" cols="30" rows="2"></textarea>
                                    </div>
                                </div>
                            </div>  
                        </div>
