        ...
        <div class="w-100 p-3">
            ...
            <nav aria-label="breadcrumb"> 
                <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Add Resolution</li>
                </ol>
            </nav> 
            <div class="p-3 d-flex justify-content-center">
                <form action="{{ route('product-resolution.store') }}" method="POST" class="d-flex flex-column w-100">
                    @csrf
                                ...
                                <div class="row d-flex p-3">
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="resolution_desc">
