        ...
        <div class="w-100 p-3">
            ...
            <nav aria-label="breadcrumb"> 
                <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Add Unit Of Measurement</li>
                </ol>
            </nav> 
            <div class="p-3 d-flex justify-content-center">
                <form action="/product/uom/add" method="POST" class="d-flex flex-column w-100">
                    @csrf
                        ...
                        <div class="accordion-item border">
                            ...
                            <div id="flush-address" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordion-flush-address">
                                <div class="row d-flex p-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            <label for="" class="form-label">Unit Of Measurement Shortame</label>
                                            <input class="form-control" type="text" name="uom_shortname">
                                            @error('uom_shortname')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
