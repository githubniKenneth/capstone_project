    ...
    @section('content')
        <div class="w-100 p-3">
            ...
            <nav aria-label="breadcrumb"> 
                <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="{{ route('product-brand.index') }}" class="text-decoration-none">Brand</a></li>
                        <li class="breadcrumb-item" aria-current="page">Add Brand</li>
                </ol>
            </nav> 
            <div class="p-3 d-flex justify-content-center">
                <form action="/product/brand/add" method="POST" class="d-flex flex-column w-100">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end mt-2">
                        ...
                        <div>
                            <a href="{{ route('product-brand.index') }}" class="btn btn-secondary rounded">Cancel</a>
        ...
        <script>
            swal({
                ...
                window.location.href = "{{ route('product-brand.index') }}";
            })
        </script>
        @endif
