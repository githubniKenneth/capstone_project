    ...
    @section('content')
        <div class="w-100 p-3">
            ...
            <div class="p-3 d-flex justify-content-center">
                <form action="/product/category/{{ $category->id }}" method="POST" class="d-flex flex-column w-100">
                @method('PUT')    
                @csrf
                    ...
                    <div class="d-flex justify-content-end mt-2">
                        ...
                        <div>
                            <a href="{{ route('product-category.index') }}" class="btn btn-secondary rounded">Cancel</a>
