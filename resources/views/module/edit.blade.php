    ...
    @section('content')
        <div class="w-100 p-3">
            ...
            <div class="p-3 d-flex justify-content-center">
                <form action="/component/module/{{$module->id}}" method="POST" class="d-flex flex-column w-100">
                    @method('PUT')
                    @csrf
                                ...
                                <div class="row d-flex p-3">
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="module_name" value="{{ $module->module_name }}">
                                            @error('module_name')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                        ...
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <select name="group_id" id="" class="form-select">
                                                ...
                                                @foreach ($groups as $group)
                                                    <option value="{{$group->id}}" {{($module->group_id == $group->id) ? "selected" :""}}>{{$group->group_name}}</option>
                                                @endforeach
                                            </select>
                                            @error('group_id')
                                                <p class="text-danger">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="module_code" value="{{ $module->module_code }}">
                                            @error('module_code')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="module_description" value="{{ $module->module_description }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
