    ...
    @section('content')
        <div class="w-100 p-3">
            ...
            <div class="p-3 d-flex justify-content-center">
                <form action="/component/group/{{ $group->id }}" method="POST" class="d-flex flex-column w-100">
                @method('PUT')    
                @csrf
                                ...
                                <div class="row d-flex p-3">
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="group_name" value="{{ $group->group_name }}">
                                            @error('group_name')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="group_code" value="{{ $group->group_code }}">
                                            @error('group_code')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="group_icon" value="{{ $group->group_icon }}">
                                            @error('group_icon')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <input class="form-control" type="text" name="group_description" value="{{ $group->group_description }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
