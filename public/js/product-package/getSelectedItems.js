  ...
  function updateDisplayForm(data) {
    ...
    $('tbody#selectedDataList').append(
        '<tr>'+
            '<td class="col-md-2 d-none"><input name="item['+ counter +'][item_id]" value='+value.id+' class="col-md-5"></input>'+
            '<td class="col-md-5">'+value.product_name+'</td>'+
            '<td class="col-md-2">'+value.uom.uom_name+'</td>'+
            '<td class="col-md-2">'+value.product_price+'</td>'+
            '<td class="col-md-2"><input class="form-control" type="text" name="item['+ counter +'][item_qty]"></input></td>'+
